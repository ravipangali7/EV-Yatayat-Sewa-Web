...
import { User, Lock, Wallet, Clock, MapPin, LogOut, ChevronRight, Camera, Edit } from "lucide-react";
...
export default function UserProfile() {
  ...
  const menuItems = [
    ...
    { icon: Wallet, label: "Wallet", onClick: () => toast.info("Open Wallet from Home") },
    { icon: Clock, label: "Booking History", onClick: () => toast.info("View recent bookings on Home") },
